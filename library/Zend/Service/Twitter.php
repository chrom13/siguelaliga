...
class Zend_Service_Twitter extends Zend_Rest_Client
{
    ...
    {
        $this->_init();
        $response = $this->_get('/1.1/account/verify_credentials.xml');
        return new Zend_Rest_Client_Result($response->getBody());
    }
    ...
    {
        $this->_init();
        $this->_get('/1.1/account/end_session');
        return true;
    }
    ...
    {
        $this->_init();
        $response = $this->_get('/1.1/account/rate_limit_status.xml');
        return new Zend_Rest_Client_Result($response->getBody());
    }
    ...
    {
        $this->_init();
        $path = '/1.1/favorites/create/' . $this->_validInteger($id) . '.xml';
        $response = $this->_post($path);
        return new Zend_Rest_Client_Result($response->getBody());
    }
    ...
    {
        $this->_init();
        $path = '/1.1/favorites/destroy/' . $this->_validInteger($id) . '.xml';
        $response = $this->_post($path);
        return new Zend_Rest_Client_Result($response->getBody());
    }
    ...
    {
        $this->_init();
        $path = '/1.1/blocks/destroy/' . $id . '.xml';
        $response = $this->_post($path);
        return new Zend_Rest_Client_Result($response->getBody());
    }
